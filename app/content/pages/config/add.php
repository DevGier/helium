...
<form method="post">
  <div class="row">
    <div class="col-12">
      ...
      <div class="input-group">
        <input type="text" name="config_name" class="form-control" placeholder="Configuration file name" value="">
        <div class="input-group-append ms-3">
          <button class="btn btn-primary" type="submit" name="add" id="add">Publish</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="row mt-4">
    <div class="col-12">
      <textarea name="content" class="form-control editor" rows="26"></textarea>
    </div>
    </div>
  </div>
</form>
