  ...
  <div class="row">
    <div class="col-12">
      ...
      <div class="input-group">
        <input type="hidden" name="template_name" class="form-control d-none" placeholder="Template name" value="<?= $data['template'] ?>">
        <input type="text" name="template_name" class="form-control" placeholder="Template name" value="<?= $data['template'] ?>" disabled>
