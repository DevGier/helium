...
(() => {
  ...
  (() => {
    ...
    const a = (function () {
      ...
      return (
        (e.prototype.render = function (e, t) {
          var n = this,
            r = "selected" in t ? t.selected : {};
          return {
            title: "Insert column",
            data: {},
            body: o(
              this.preset.breakpoints.map(function (e) {
                return n.breadpoint(e, r);
              })
            ),
            onSubmit: e,
          };
    ...
    const u = (function (e) {
      function n(t, r, i, o) {
        ...
        return (
          ...
          (s.editor = i),
          (s.i18n = o),
          (s.insertColumnDialog = new a(s.preset)),
          (s.insert = s.insert.bind(s)),
          (s.insertAfter = s.insertAfter.bind(s)),
          (s.insertBefore = s.insertBefore.bind(s)),
          (s.delete = s.delete.bind(s)),
          (s.properties = s.properties.bind(s)),
          (s.onInsertSubmit = s.onInsertSubmit.bind(s)),
          i.addCommand(n.CMD_INSERT_BEFORE_COLUMN, s.insertBefore),
          i.addCommand(n.CMD_INSERT_AFTER_COLUMN, s.insertAfter),
          i.addCommand(n.CMD_DELETE_COLUMN, s.delete),
          i.addCommand(n.CMD_PROPERTIES_COLUMN, s.properties),
                  ...
                  function (e) {
                    ...
                    var i = function (t) {
                      if (e.data.hasOwnProperty(t)) {
                        ...
                        r.classList.add(n.preset.displayClass(o.preffix, i));
                      }
                    };
      ...
      function n(t, r, i, o) {
        ...
        return (
          ...
          s.editor.addContextToolbar(
            ...
            n.BTN_DELETE_GRID +
              " | " +
              u.BTN_COLUMN_PROPERTIES +
              " " +
              u.BTN_COLUMN_INSERT_BEFORE +
              " " +
              u.BTN_COLUMN_INSERT_AFTER +
              " " +
              u.BTN_COLUMN_DELETE +
              " | " +
              c.BTN_ROW_INSERT_BEFORE +
              " " +
              c.BTN_ROW_INSERT_AFTER +
              " " +
              c.BTN_ROW_DELETE
          ),
          s
          ...
          return (
            ...
            (e.prototype.renderColumn = function (e) {
              var t =
                  '<div class="grid-col ' +
                  (
                    (e.extra_small.length > 0
                      ? "col-sm-" + e.extra_small
                      : "") +
                    " " +
        ...
        Bootstrap4: (function () {
          function e(e, t) {
            ...
            (this.settings = e),
              ...
              (this.columnDisplayRegex = function (e) {
                return new RegExp("d-" + e + "-([a-zA-Z]+)", "gi");
              }),
              (this.columnClass = function (e, t) {
                return "col-" + e + "-" + t;
              }),
              (this.displayClass = function (e, t) {
                if(t > 0){
                  if(e == "xs"){
                    return "d-block";
                  } else {
              ...
              (this.isColumn = function (e) {
                ...
                return !!n.breakpoints.find(function (t) {
                  return !!n.columns.find(function (r) {
                    return n.displayClass(t.preffix, r.value) === e;
                  });
                });
              });
          }
        ...
        return r(void 0, void 0, void 0, function () {
          ...
          return i(this, function (i) {
            return (
              (n = new m(e)),
              (r = (function (e, t) {
                return new f[e.preset]();
              })(n)),
              e.contentCSS.push(t + "/" + r.style()),
              new s(n, e, tinymce.util.I18n),
              new c(n, r, e, tinymce.util.I18n),
              new u(n, r, e, tinymce.util.I18n),
              new d(n, r, e, tinymce.util.I18n),
              [2]
            );
          });
        });
    ...
    tinymce.PluginManager.requireLangPack("grid"),
      tinymce.PluginManager.add("grid", p);
  })();
})();
